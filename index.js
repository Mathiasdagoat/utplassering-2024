	...
	.addEventListener("submit", function (event) {
		...
		if (pattern.test(username)) {
			document.body.innerHTML =
				"<div style='color: black; text-align: center; font-size: 150px; margin-top: 10%;'><h1>nu uh</h1></div>";
		} else {
...
function revealRandomLetter() {
	var hiddenLetters = document.querySelectorAll(
		".hangman-letter:not(.visible)"
	);
